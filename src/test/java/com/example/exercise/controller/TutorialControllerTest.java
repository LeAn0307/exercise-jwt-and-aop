...
class TutorialControllerTest {
    ...
    void getListTutorials() throws Exception {
        ...
        when(tutorialService.findByTitleLike("title1")).thenReturn(tutorialList);
        ...
        //Case 4
        TutorialEntity tutorial3 = new TutorialEntity(1L, "title12", "description1", true);
        TutorialEntity tutorial4 = new TutorialEntity(2L, "title122", "description2", true);
    ...
    void createTutorial() throws Exception {
        TutorialEntity newTutorial = new TutorialEntity(1L, "title1", "des1", false);
        when(tutorialService.saveTutorial(any(TutorialEntity.class))).thenReturn(newTutorial);
